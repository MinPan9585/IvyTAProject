...
Shader "SinCourse/BlendTexture+Alpha+Distortion+Gradient+2UV+Dissolve+Line"
{
	Properties
	{
		...
		[Toggle(_GRADIENTTOLINE_ON)] _GradientToLine("GradientToLine", Float) = 0
	...
	SubShader
	{
		...
		#pragma shader_feature _GRADIENTTOLINE_ON
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			#endif
			float3 temp_output_62_0 = (tex2D( _GradientTex, ( ( appendResult53 * _Time.y ) + staticSwitch65 ) )).rgb;
			...
			#endif
			float clampResult110 = clamp( ( (tex2D( _SoftDissolveTex, ( ( appendResult75 * _Time.y ) + staticSwitch131 ) )).r + 1.0 + ( _SoftDissolveIndensity * -2.0 ) ) , 0.0 , 1.0 );
			float smoothstepResult114 = smoothstep( ( 1.0 - _SoftDissolveSoft ) , _SoftDissolveSoft , clampResult110);
			float smoothstepResult115 = smoothstep( _SoftDissolveSoftMin , _SoftDissolveSoftMax , clampResult110);
			#ifdef _SOFTMINMAXSWITCH_ON
				float staticSwitch118 = smoothstepResult115;
			#else
				float staticSwitch118 = smoothstepResult114;
			#endif
			float temp_output_138_0 = ( step( staticSwitch118 , _LineRange ) - step( ( _LineWidth + staticSwitch118 ) , _LineRange ) );
			float3 temp_cast_4 = (temp_output_138_0).xxx;
			#ifdef _GRADIENTTOLINE_ON
				float3 staticSwitch154 = ( temp_output_62_0 * temp_output_138_0 );
			#else
				float3 staticSwitch154 = temp_cast_4;
			#endif
			float3 DissolveLine139 = staticSwitch154;
			o.Emission = ( float4( ( ( temp_output_62_0 * (tex2DNode1).rgb ) * _Indensity * (_Color).rgb ) , 0.0 ) + ( float4( DissolveLine139 , 0.0 ) * _LineColor * _LineIndensity ) ).rgb;
			...
			float temp_output_14_0 = ( tex2DNode1.a * _Color.a * (desaturateVar30).x );
				...
				float staticSwitch126 = ( temp_output_14_0 * staticSwitch118 );
			#else
				float staticSwitch126 = temp_output_14_0;
			#endif
			float OpacityGroup151 = temp_output_14_0;
			o.Alpha = ( ( staticSwitch126 + ( DissolveLine139 * OpacityGroup151 ) ) * _Opacity ).x;
		}
...
/*ASEBEGIN
Version=17000
0;0;1920;1029;1213.544;-1309.336;1.138795;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;103;-2592.954,2335.246;Float;False;Property;_SoftDissolveIndensity;SoftDissolveIndensity;25;0;Create;True;0;0;False;0;0;0.52;0;1.05;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;105;-2398.73,2060.325;Float;True;True;False;False;False;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;108;-2147.025,2205.664;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;109;-1782.682,2308.072;Float;False;Property;_SoftDissolveSoft;SoftDissolveSoft;26;0;Create;True;0;0;False;0;0;0.55;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;110;-2025.667,2205.459;Float;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;114;-1440.2,2222.274;Float;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;132;-609.9569,2057.277;Float;False;1191.28;539.6665;软溶解描边;6;138;137;136;135;134;133;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;115;-1789.382,2380.073;Float;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;133;-559.9569,2107.277;Float;False;Property;_LineWidth;LineWidth;31;0;Create;True;0;0;False;0;0.1;0.47;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;134;-391.957,2108.277;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;135;-374.3651,2328.913;Float;False;Property;_LineRange;LineRange;30;0;Create;True;0;0;False;0;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;137;-157.9568,2107.277;Float;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;136;-145.8335,2355.523;Float;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;138;96.0437,2170.277;Float;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;152;283.8181,1797.965;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;154;469.099,1937.644;Float;False;Property;_GradientToLine;GradientToLine;34;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-635.5317,507.2513;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;146;25.62189,705.6975;Float;False;455.077;243.3826;描边alpha;3;149;148;147;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;139;708.7611,2150.948;Float;False;DissolveLine;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;127;-412.5908,443.3786;Float;False;537.0822;256.2446;软溶解开关;2;128;126;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;151;-493.2561,707.7957;Float;False;OpacityGroup;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;149;81.73187,755.899;Float;False;139;DissolveLine;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ComponentMaskNode;13;-731,17;Float;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;140;318.3261,-181.4318;Float;False;593.2806;524.3915;描边叠加;5;145;144;143;142;141;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;128;-369.9106,557.9702;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;148;75.62189,834.0801;Float;False;151;OpacityGroup;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;143;368.3261,-17.43945;Float;False;139;DissolveLine;1;0;OBJECT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;147;311.6989,755.6975;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;141;391.0151,227.2933;Float;False;Property;_LineIndensity;LineIndensity;33;0;Create;True;0;0;False;0;1;17;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;142;350.5971,57.4352;Float;False;Property;_LineColor;LineColor;32;1;[HDR];Create;True;0;0;False;0;1,1,1,1;0.2688679,0.7511713,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;11;1083.529,817.0063;Float;False;Property;_Opacity;Opacity;1;0;Create;True;0;0;False;0;1;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;150;465.8499,580.8506;Float;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;144;589.1911,29.99698;Float;False;3;3;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;145;755.608,-131.4319;Float;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;129;1130.95,550.4214;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1402.349,102.4515;Float;False;True;2;Float;ASEMaterialInspector;0;0;Lambert;SinCourse/BlendTexture+Alpha+Distortion+Gradient+2UV+Dissolve+Line;False;False;False;False;True;True;True;True;True;True;True;True;False;False;False;False;False;False;False;False;False;Off;2;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;0;True;Custom;;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;1;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;35;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;152;0;62;0
WireConnection;152;1;138;0
...
ASEEND*/
//CHKSM=68E3E8CFC8F5ADD5D998069182FFF7571FEF2A75