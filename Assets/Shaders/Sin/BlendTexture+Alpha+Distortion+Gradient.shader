...
Shader "SinCourse/BlendTexture+Alpha+Distortion+Gradient"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float3 desaturateInitialColor43 = tex2D( _DistortionTex, ( uv0_DistortionTex + ( appendResult35 * _Time.y ) ) ).rgb;
			...
			float3 lerpResult44 = lerp( float3( ( ( appendResult6 * _Time.y ) + uv0_MainTex ) ,  0.0 ) , desaturateVar43 , _DistortionIndensity);
			float4 tex2DNode1 = tex2D( _MainTex, lerpResult44.xy );
			o.Emission = ( ( (tex2D( _GradientTex, ( ( appendResult53 * _Time.y ) + uv0_GradientTex ) )).rgb * (tex2DNode1).rgb ) * _Indensity * (_Color).rgb );
			float2 appendResult21 = (float2(_AlphaU , _AlphaV));
			float2 uv0_AlphaTex = i.uv_texcoord * _AlphaTex_ST.xy + _AlphaTex_ST.zw;
			float3 desaturateInitialColor30 = tex2D( _AlphaTex, ( ( appendResult21 * _Time.y ) + uv0_AlphaTex ) ).rgb;
...
/*ASEBEGIN
Version=17000
0;0;1920;1029;3578.194;1748.072;1.9;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-2483.785,-375.2852;Float;False;Property;_DistortionV;DistortionV;8;0;Create;True;0;0;False;0;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;34;-2483.785,-455.2852;Float;False;Property;_DistortionU;DistortionU;7;0;Create;True;0;0;False;0;0;-0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;47;-2267.675,-1023.165;Float;False;719.1189;379.1068;渐变叠加贴图流动;7;57;55;54;53;52;51;50;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-2051.21,113.086;Float;False;Property;_MainV;MainV;12;0;Create;True;0;0;False;0;0;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-2054.209,36.08621;Float;False;Property;_MainU;MainU;11;0;Create;True;0;0;False;0;0;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-1961.01,771.3279;Float;False;Property;_AlphaU;AlphaU;14;0;Create;True;0;0;False;0;0;-0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-1958.01,848.3282;Float;False;Property;_AlphaV;AlphaV;15;0;Create;True;0;0;False;0;0;-0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;50;-2217.675,-968.7647;Float;False;Property;_GradientTexU;GradientTexU;4;0;Create;True;0;0;False;0;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-2214.676,-891.7648;Float;False;Property;_GradientTexV;GradientTexV;5;0;Create;True;0;0;False;0;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;42;-1843.786,-535.2855;Float;True;Property;_DistortionTex;DistortionTex;6;0;Create;True;0;0;False;0;None;369c020ad9005f345842e241d7c188ef;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleTimeNode;52;-2024.137,-878.5576;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;53;-2021.674,-971.1646;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;54;-1858.674,-973.1646;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;45;-1553.097,-206.6291;Float;False;Property;_DistortionIndensity;DistortionIndensity;9;0;Create;True;0;0;False;0;0;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;55;-2025.437,-807.0576;Float;False;0;61;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;57;-1704.555,-959.5706;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;28;-1335.435,758.7104;Float;True;Property;_AlphaTex;AlphaTex;13;0;Create;True;0;0;False;0;None;06ca7f4e15d38b44ea670db94e64af32;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-1022,18;Float;True;Property;_MainTex;MainTex;10;0;Create;True;0;0;False;0;None;06ca7f4e15d38b44ea670db94e64af32;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-687.3669,100.3918;Float;False;Property;_Indensity;Indensity;0;0;Create;True;0;0;False;0;1;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;89.79996,80.6;Float;False;True;2;Float;ASEMaterialInspector;0;0;Lambert;SinCourse/BlendTexture+Alpha+Distortion+Gradient;False;False;False;False;True;True;True;True;True;True;True;True;False;False;False;False;False;False;False;False;False;Off;2;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;0;True;Custom;;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;1;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;16;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=A3481D142E0A4E32FEF830C5386AD68EAAC7F492